...
def materials__fromJSON( inpFile=None, outFile=None, charSize=2.0 ):
    ...
    # ------------------------------------------------- #
    ret = generate__materialFile( matDB=matDB, outFile=outFile, charSize=charSize )
    return()
...
def generate__materialFile( outFile=None, matDB=None, keys=None, charSize=2.0 ):
...
if ( __name__=="__main__" ):
    inpFile = "cnf/materials_database.json"
    outFile = "inp/materials_phits.inp"
    materials__fromJSON( inpFile=inpFile, outFile=outFile )
