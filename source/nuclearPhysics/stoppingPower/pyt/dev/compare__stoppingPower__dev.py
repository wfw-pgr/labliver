...
def display():
    ...
    # ------------------------------------------------- #
    inpFiles   = [ "dat/parameter__e_in_Ta.json", 
                   "dat/parameter__e_in_Pt.json" ]
    pngFile    = "png/compare__TaPt.png"
    keys       = [ "Ta", "Pt" ]
    DataDict   = {}
    paramsList = []
    for ik,inpFile in enumerate(inpFiles):
        ...
        Data  = { "Scol":Scol, "Srad":Srad, "Stot":Stot, "ratio":ratio }
        DataDict[keys[ik]] = Data
