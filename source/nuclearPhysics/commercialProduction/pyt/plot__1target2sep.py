...
def display():
    ...
    datFilesList = [ [ "dat/1target_2sep/result__1target_2sep_{0}_{1}.dat".format( iON, iOFF )
    ...
    outFile   = "dat/p365__1target_2sep.dat"
    ...
    config_  = {
        "figure.size"        : [4.5,4.5],
        "figure.pngFile"     : "png/beamon_vs_cummulate__1target2sep.png", 
    ...
    config_   = {
        "figure.size"        : [4.5,4.5],
        "figure.pngFile"     : "png/beamoff_vs_cummulate__1target2sep.png", 
	"figure.position"    : [ 0.16, 0.16, 0.94, 0.94 ],
        "ax1.y.normalize"    : 1.0e9, 
